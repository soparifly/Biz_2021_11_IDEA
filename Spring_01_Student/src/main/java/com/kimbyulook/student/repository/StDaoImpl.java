...
public class StDaoImpl implements StDao{
    ...
    private final String[] stNames = {"홍길동", "이몽룡", "성춘향", "임꺽정", "장영실", "장보고"};
    ...
    public List<StudentVO> selectAll() {
        ...
        for(int i = 0; i <10 ; i++){
            ...
            StudentVO vo = StudentVO.builder()
                    .st_num(stNum)
                    .st_name(stName)
                    .st_dept("컴퓨터공학").st_address("광주광역시")
                    .st_tell(String.format("062-%04d-$04d",RND.nextInt(9999)+1,RND.nextInt(9999)+1))
                    .build();
